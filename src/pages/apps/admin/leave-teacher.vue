...
<template>
  <div class="profile-management">
    ...
    <div class="bar-style-top">
      ...
      <!--        </IconField>-->
      <!--        &lt;!&ndash;        <Button label="Report" class="btn" />&ndash;&gt;-->
      <!--      </div>-->
    </div>
    ...
    <div class="p-dialog">
      <Dialog
        class="rounded-50% dialog"
        v-model:visible="visible"
        modal
        header="View Request Leave"
        :style="{ width: '55rem' }"
      >
        <div class="form-col">
          <div class="form-row">
            <div class="form-group">
              ...
              <div class="display" id="fullname">NOP Phearum</div>
            </div>
            <div class="form-group">
        ...
        <div class="form-col">
          <div class="form-row">
            <div class="form-group">
              ...
              <div class="display" id="line_manager">LAY HENG</div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="display" id="type">Sick</div>
            </div>
          </div>
        </div>
        <div class="form-col">
    ...
    <!--    <div class="card flex flex-wrap gap-2 justify-center"></div>-->
