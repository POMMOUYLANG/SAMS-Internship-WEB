...
<template>
  <div class="profile-management">
    ...
    <div class="bar-style-top">
      ...
      <!--        </IconField>-->
      <!--        <router-link to="/apps/admin/profile-student-add">-->
      <!--          <Button label="Add" icon="pi pi-plus" class="btn" />-->
      <!--        </router-link>-->
      <!--      </div>-->
    </div>
        ...
        >
          ...
          <Column header="Action" style="width: 15rem">
            <template #body="{ rowData }">
              ...
              <router-link to="/apps/admin/profile-student-edit">
                <Button
                  icon="pi pi-pencil"
