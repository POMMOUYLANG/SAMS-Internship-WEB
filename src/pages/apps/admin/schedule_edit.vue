<template>
  <div class="profile-management">
    ...
    <div class="edit-section">
      ...
      <div class="back">
        <router-link to="/apps/admin/schedule">
          <button
                ...
                <div class="input-group">
                  <div class="form-group">
                    <input
                      class="input-info"
                      type="text"
                      v-model="timetable[slot.time][day].subject"
                      placeholder="Subject"
                    />
                  </div>
                  <div class="form-group">
                    <input
                      class="input-info"
                      type="text"
                      v-model="timetable[slot.time][day].teacher"
                      placeholder="Teacher"
                    />
                  </div>
                  <div class="form-group">
                    <input
                      class="input-info"
                      type="text"
                      v-model="timetable[slot.time][day].type"
                      placeholder="Type"
                    />
                  </div>
                  <div class="form-group">
                    <input
                      class="input-info"
                      type="text"
                      v-model="timetable[slot.time][day].group"
                      placeholder="Group"
                    />
                  </div>
                  <div class="form-group">
                    <input
                      class="input-info"
                      type="text"
                      v-model="timetable[slot.time][day].class"
                      placeholder="Class"
                    />
                  </div>
                  <div class="form-group">
